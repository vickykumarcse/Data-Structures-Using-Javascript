...
describe('DoublyNode', () => {
  ...
  it('should create a node with object as a value', () => {
    ...
    const node = new DoublyNode(nodeValue);
  ...
  it('should link nodes together', () => {
    const node2 = new DoublyNode(20);
    const node1 = new DoublyNode(10, node2);
    ...
    expect(node2.previous.value).toBe(10);
  });
